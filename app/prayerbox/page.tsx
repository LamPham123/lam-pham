    ...
    <div className="relative bg-gray-50">
      ...
      <div className="mb-16">
        ...
        >
          <ProjectPage
            title="PrayerBox!"
            description="PrayerBox makes it easier than ever to pray with and for your community. Sign in effortlessly with just your email and a confirmation code—no need to create an account. Join or create groups using a simple 6-digit code and start sharing prayer requests instantly."
            images={["/prayerbox.png", "/images/veym2.png"]}
            technologies={[
              "React Native",
              "JavaScript",
              "instantDB",
            ...
            projectUrl="https://prayer-box.netlify.app/"
          />
        </motion.div>
      </div>
        ...
        <motion.section variants={itemAnimation} className="space-y-4">
          ...
          <div className="prose prose-lg">
            <p>
              ...
              reactions since our release in October.
            </p>
          </div>
        </motion.section>
